...
TESTBENCHES=(adder_tree_32bit_tb mult_adder_tb ram_sr_tb\
  ...
  requantize_32bit_tb requantize_9bit_tb mult_8bit_signed_tb\
  add_8bit_signed_tb add_32bit_signed_tb convolution_2D_padded_tb\
  convolution_25D_padded_tb dense_2D_padded_tb dense_25D_padded_tb\
  convolution_fsm_tb)
